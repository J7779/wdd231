...
const thebtns = document.querySelectorAll(".button-box button");
...
function currentShowButton(n) {
    thebtns.forEach((btn) => btn.classList.remove("activebtn"));
    thebtns[n].classList.add("activebtn");
}

thebtns.forEach((btn, index) => {
